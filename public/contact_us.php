                        ...
                        <div class="card p-3 border border-3 border-primary1 bg-primary1" >
                            <form id="contact_us" method="POST" action="send_email.php">
                                ...
                                <div class="mb-3 form-floating">
                                    <textarea class="form-control" name="Message" id="Message" style="min-height:200px" placeholder="" required></textarea>
                            ...
                            <p class="text-danger d-none" id="message_fail">message failed to send</p>
                        </div>
                    </div>
                </div>
            </div>
