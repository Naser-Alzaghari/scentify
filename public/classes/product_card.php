    ...
    class product_card {
        ...
        public function render() {
            echo "<form action='newindex.php' method='get' class='col-sm-6 col-md-4 col-lg-3 mb-3 mb-md-0 h-100'>
                            ...
                            <div class='card card-span h-100 text-white bg-400 p-2 mb-3'><img class='img-fluid rounded h-100 mb-2' src='assets/img/gallery/{$this->product['product_image']}' alt='...'>
                                <div class='ps-0'> </div>
                                <div class='card-body p-0 bg-transparent'>
                                    ...
                                    <button type='button' class='btn btn-dark w-100 add-to' data-bs-toggle='modal' data-bs-target='#exampleModal' id='add_item_{$this->product['product_id']}' product_id={$this->product['product_id']}>
